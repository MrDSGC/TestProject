...
class ImInterestedButton extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.eventObject) {
      subscribeCountToRender = nextProps.eventObject.subscribeCount ? nextProps.eventObject.subscribeCount : 0;
    }

    var alreadySubscribed = false;
    if (nextProps.eventObject && nextProps.eventObject.currentUserAlreadySubscribed) {
      alreadySubscribed = true;
    }
    ...
    return (
      <MuiThemeProvider>
        <div>
          ...
          >
            <b>Enter your email to get notified when we launch.</b> We will send you an email to confirm.
...
export default connect(mapStateToProps)(ImInterestedButton);
